...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { img_link: @artwork.img_link, is_public: @artwork.is_public, name: @artwork.name, value: @artwork.value } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { img_link: @artwork.img_link, is_public: @artwork.is_public, name: @artwork.name, value: @artwork.value } }
